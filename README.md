...
- скачивать сохранения через отдельную вкладку `Сохранения`.
...
6. Во вкладке `Сохранения` скачайте backup, если нужно сохранить или перенести результаты.
...
Файловые сохранения лежат отдельно:
