...
class WebUiTests(unittest.TestCase):
    def test_index_html_is_focused_on_strategy_finder_only(self) -> None:
        ...
        self.assertIn("/api/backups/restore-preview", html)
        self.assertIn("/api/backups/download", html)
        self.assertIn("backup-restore-select", html)
        self.assertIn("backup-restore-preview", html)
        ...
        self.assertNotIn("data-backup-restore", html)
        self.assertIn("restoreBackup", html)
        self.assertIn("refreshBackupRestorePreview", html)
        self.assertIn("renderBackupRestorePreview", html)
        ...
        self.assertNotIn("candidate-filter", html)
